...
export const HomePage = () => {
  ...
  return (
    <div className="homepage">
      <h1 style={theme ? {color: "#000"} : {}} className="homepagesumit">Welcome to the Recipe Management App By Himanshu Vashishtha  <br/><h1>Explore Your Cuisines and Cook Tasty For Your LovedOnes </h1></h1>
      <Search1
